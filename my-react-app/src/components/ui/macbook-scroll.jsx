...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="flex min-h-[120vh] shrink-0 scale-[0.5] transform flex-col items-center justify-center pt-0 pb-[12rem] [perspective:800px] sm:scale-75 md:scale-110 lg:scale-125 md:pt-5 md:pb-[16rem]">
      <motion.h2
        style={{
  ...
  return (
    <div className="relative [perspective:800px]">
      ...
      <motion.div
        ...
        className="absolute inset-0 h-[460px] w-[32rem] rounded-2xl bg-[#010101] p-2">
